...
<div class="publications">
  ...
  <h3 class="year" id="GDL" style="padding-top:2em">myAirCoach</h3>

{% bibliography -f papers -q @*[projects=myAirCoach ]* %}

  <h3 class="year" id="AIBE" style="padding-top:2em">AI & Machine Learning in the Built Environment</h3>

{% bibliography -f papers -q @*[category_1=AIBE || category_2=AIBE]* %}

  <h3 class="year" id="PHD" style="padding-top:2em">Doctoral Dissertation</h3>
...
{% bibliography -f papers -q @*[category_1=PHD || category_2=PHD]* %}
  ...
  <h3 class="year" id="BME" style="padding-top:2em">Computational Methods in Biomedical Engineering</h3>

{% bibliography -f papers -q @*[category_1=BME || category_2=BME]* %}

  <h3 class="year" id="MLHM" style="padding-top:2em">Machine Learning for Healthcare and Medicine</h3>

{% bibliography -f papers -q @*[category_1=MLHM || category_2=MLHM  || category_3=MLHM]* %}

  <h3 class="year" id="MCA" style="padding-top:2em">Efficient AI, Model Compression and Acceleration in DNNs</h3>

{% bibliography -f papers -q @*[category_1=MCA || category_2=MCA]* %}

  <h3 class="year" id="MCDI" style="padding-top:2em">Sparse Modelling for Data Imputation</h3>

{% bibliography -f papers -q @*[category_1=MCDI || category_2=MCDI]* %}

  <h3 class="year" id="Gamification" style="padding-top:2em">Application: Gamification</h3>
